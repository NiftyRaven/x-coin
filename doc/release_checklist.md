...
**Post Release :**
  ...
  1. Update github.com/NiftyRaven/x-coin with correct popup version
  
  2. Update github.com/NiftyRaven/x-coin with correct release download urls for each platform (Windows, Linux, Mac)
