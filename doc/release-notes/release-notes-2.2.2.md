X Coin version *2.2.2* is now available!!
==============

  <https://github.com/NiftyRaven/x-coin/releases/tag/v2.2.2>
...
- Enhancements for X Coin Dev Kit and Mobile Wallet Support
...
Changelog available here: <https://github.com/NiftyRaven/x-coin/commits/release_2.2.2>
