X Coin version *2.1.0* is now available!!
==============

  <https://github.com/NiftyRaven/x-coin/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/NiftyRaven/x-coin/commits/release_2.1.0>
