X Coin version *2.0.4.0* is now available!!
==============

  <https://github.com/NiftyRaven/x-coin/releases/tag/v2.0.4>
...
Changelog available here: <https://github.com/NiftyRaven/x-coin/commits/release_2.0.4>
