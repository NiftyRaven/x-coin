...
====================
Some notes on how to build X Coin in *nix.
...
As mentioned above, when maintaining portability of the wallet between the standard X Coin distributions and independently built
