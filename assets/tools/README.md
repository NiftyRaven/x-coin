...
### IPFS Pinner
Loops through blocks and transactions and pins asset issuance meta-data and then monitors xcoind transactions for new ipfs metadata via zmq.
...
* Run xcoind or xcoin-qt with parameter to use zmq: ```-zmqpubrawtx=tcp://127.0.0.1:28766```
