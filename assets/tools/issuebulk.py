#!/usr/bin/env python3
# Script to issue assets on the X Coin platform
...
# Prerequisite: xcoind daemon to be running
...
#Set this information in your xcoin.conf file (in datadir, not testnet3)
rpc_user = 'rpcuser'
rpc_pass = 'rpcpass555'
