...
class SegWitTest(RavenTestFramework):
    ...
    def test_unnecessary_witness_before_segwit_activation(self):
        ...
        # Right now, xcoind delays sending reject messages for blocks
    ...
    # To enable this test, pass --oldbinary=<path-to-pre-segwit-xcoind> to
    # the test.
    def test_upgrade_after_activation(self, node_id):
        self.log.info("Testing software upgrade after softfork activation")

        assert (node_id != 0)  # node0 is assumed to be a segwit-active xcoind
