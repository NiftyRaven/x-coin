...
**Download [1.0.13](https://github.com/NiftyRaven/x-coin/releases/tag/v1.0.13).**
Do not run 1.0.12 or older if you need Claim My Asset to confirm. Seed is lottery law.
...
1. Download [X-Coin-1.0.13-Windows.zip](https://github.com/NiftyRaven/x-coin/releases/download/v1.0.13/X-Coin-1.0.13-Windows.zip).
...
1. Download [X-Coin-1.0.13-Linux-x86_64.tar.gz](https://github.com/NiftyRaven/x-coin/releases/download/v1.0.13/X-Coin-1.0.13-Linux-x86_64.tar.gz).
2. Right-click → Extract, or run `tar -xzf X-Coin-1.0.13-Linux-x86_64.tar.gz`.
