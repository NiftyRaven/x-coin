...
- [Windows wallet](https://github.com/NiftyRaven/x-coin/releases/download/v1.0.8/X-Coin-1.0.8-Windows.zip) → double-click **X Coin Wallet.exe**
- [Linux wallet](https://github.com/NiftyRaven/x-coin/releases/download/v1.0.8/X-Coin-1.0.8-Linux-x86_64.tar.gz) → double-click **X Coin Wallet**
