...
**Heavy 1.0.17** (Market + tree nav). In-tree is Heavy:
[v1.0.17](https://github.com/NiftyRaven/x-coin/releases/tag/v1.0.17)

- [Windows Heavy](https://github.com/NiftyRaven/x-coin/releases/download/v1.0.17/X-Coin-1.0.17-Windows.zip) → **X Coin Wallet.exe**
- [Linux Heavy](https://github.com/NiftyRaven/x-coin/releases/download/v1.0.17/X-Coin-1.0.17-Linux-x86_64.tar.gz) → **X Coin Wallet**

Do not use 1.0.2–1.0.16 as current Heavy. Light 1.0.16 still
follows this chain.
