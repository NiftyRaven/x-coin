...
#endif // ENABLE_WALLET
    const QString netTag = networkStyle->getTitleAddText();
    if (netTag.contains(QStringLiteral("regtest"), Qt::CaseInsensitive)) {
        windowTitle += tr("Practice Wallet");
    } else if(enableWallet) {
