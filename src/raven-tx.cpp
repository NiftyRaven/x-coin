...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s xcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  xcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded raven transaction") + "\n" +
              "  xcoin-tx [options] -create [commands]   " + _("Create hex-encoded raven transaction") + "\n" +
              "\n";
